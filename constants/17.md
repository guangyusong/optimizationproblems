...
$C_{17}$ is the limit (if it exists) of $R(k)^{1/k}$ as $k \to \infty$, where the diagonal Ramsey number $R(k)$ is the smallest integer $n$ such that every red/blue colouring of the edges of the complete graph $K_n$ contains a monochromatic copy of $K_k$.
